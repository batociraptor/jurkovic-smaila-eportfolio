document.addEventListener('DOMContentLoaded', function () {
    ...
    const courses = [
        ...
        ["Programiranje za umjetnu inteligenciju", "Analiza podataka velikog obujma", "Analiza senzorskih podataka", "Dubinska analiza podataka", "E-učenje za obrazovanje i poslovanje", "Infrastruktura podataka velikog obujma", "Multivarijantna analiza", "Strojno i duboko učenje", "Digitalne transformacije", "Prikaz znanja i rezoniranje o zanju"]
    ];
    ...
    const workExperiences = [
        ...
        {
            program: "Blender",
            description: "Profesionalni softver za izradu 3D grafike."
        },
        {
            program: "Figma",
        ...
        },
        {
            ...
            description: "Integrirano razvojno okruženje za izradu aplikacija u različitim programskim jezicima."
        }
    ];
